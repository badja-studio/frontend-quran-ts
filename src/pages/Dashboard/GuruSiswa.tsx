...
import DataTable, { Column, formatStatus, FilterConfig, FilterItem, ExportType } from '../../components/Table/DataTable';
  ...
  const columns: Column<Siswa>[] = [
    ...
    },
    {
      ...
      format: (value) => {
        ...
        return (
          <Chip label={nilai} size="small" color={color} />
        );
      },
    },
    {
      ...
      format: (value) => {
        ...
        return (
          <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 1 }}>
            ...
            <Chip label="" size="small" color={color} sx={{ width: 8, height: 8, minWidth: 8 }} />
          </Box>
        );
      },
    },
