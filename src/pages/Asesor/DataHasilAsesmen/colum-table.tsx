import { DataPersetaHasil } from "./type";
import { Column } from "../../../components/Table/DataTable";
import { Box, Typography, Chip, Avatar } from "@mui/material";

export const columnsPeserta: Column<DataPersetaHasil>[] = [
  {
    id: "no_akun",
    label: "No. Akun",
    minWidth: 100,
  ...
  { id: "mad", label: "Skor Mad ", minWidth: 120, align: "center" },
